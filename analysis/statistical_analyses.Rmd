...
fit.c1_gen <- lmer(baseline_corrected ~ 1 + expectation + attention + visual_field + 
...
## full model
```{r}
fit.p3.full <-  lmer(baseline_corrected ~ 1 + attention + expectation + attention*expectation +
                           (1 | subject)+ (attention | subject)+ (expectation| subject),
  data = df, 
