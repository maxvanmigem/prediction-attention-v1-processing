...
df <- read.csv('C:/Users/mvmigem/Documents/data/project_1/compiled_dataframes/uc_rerp_c1_fix_df.csv')
# df <- read.csv('C:/Users/mvmigem/Documents/data/project_1/compiled_dataframes/uc_rerp_c1_var_df.csv')
# df <- read.csv('C:/Users/mvmigem/Documents/data/project_1/compiled_dataframes/uc_rerp_p1.csv')
...
f1 <- amp ~ 1 + expectation + attention + visual_field + 
               attention*expectation*visual_field +
               (1 + attention + expectation + visual_field | subject)

f2 <- c1_amp ~ 1 + expectation + attention + visual_field + 
               attention*expectation*visual_field +
               (1 | subject)
...
#                   (1 + attention + expectation + visual_field | subject)
f1 <- y_bc ~ 1 + expectation + attention +
                       attention*expectation + 
                  (1 +attention+  expectation  | subject)

f2 <- y_bc ~ 1 + expectation + attention +
                       attention*expectation+
                  (1 +attention | subject)
...
# acc
```{r}
fit.behaviour_acc <-  lmer(miss_rate ~ 1 + attention +
                           (1 | participant),
  data = df, 
  control = lmerControl(optimizer = c("Nelder_Mead"), optCtrl=list(maxfun=2e6)))
